========================================================================
    ACTIVE TEMPLATE LIBRARY : dll Project Overview
========================================================================

AppWizard has created this dll project for you to use as the starting point for
...
dll.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (dll.h)
        GUID definitions                                (dll_i.c)
        A type library                                  (dll.tlb)
        Marshaling code                                 (dll_p.c and dlldata.c)

dll.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in dll.idl. It will be regenerated by MIDL during compilation.
...
dllps.vcxproj
	...
	dlldata.c, dll_i.c and dll_p.c which are required
	to build the proxy/stub DLL.

dllps.vcxproj.filters
